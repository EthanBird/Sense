...
OUT="$ROOT/build/offline-m0"
APK_DIR="$ROOT/app/build/outputs/apk/offline"
APK="$APK_DIR/Sense-v0.1.0-m0-debug.apk"
...
java -cp "$STDLIB:$JUNIT:$HAMCREST:$OUT/core-main:$OUT/core-test" \
    ...
    io.github.ethanbird.senseime.core.FakeDecoderTest | tee "$OUT/unit-tests.txt"
...
echo "M0 verification complete: $APK"
