...
OUT="$ROOT/build/offline-v0.4.5.beta.1"
...
PY
grep -F "package: name='io.github.ethanbird.senseime' versionCode='22' versionName='0.4.5.beta.1'" "$OUT/apk-badging.txt"
...
echo "v0.4.5.beta.1 verification complete: $APK"
