...
)
{
    ...
    else
    {
        ...
        // Route every rendered byte into the shared virtual-cable FIFO.
...
--*/
{
    ...
    while (ByteDisplacement > 0)
    {
        ...
        SenseMicRingRead(m_pDmaBuffer + bufferOffset, runWrite);
...
--*/
{
    ...
    {
        ULONG runWrite = min(ByteDisplacement, m_ulDmaBufferSize - bufferOffset);
        SenseMicRingWrite(m_pDmaBuffer + bufferOffset, runWrite);
